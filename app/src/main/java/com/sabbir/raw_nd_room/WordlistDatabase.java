...
public class WordlistDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE [WORD_LIST_TABLE]("+
        ...
        db.execSQL("INSERT INTO [WORD_LIST_TABLE] (word, definition) VALUES  ('alpha','first_letter');");
        db.execSQL("INSERT INTO [WORD_LIST_TABLE] (word, definition) VALUES ('betta','second_letter');");
        db.execSQL("INSERT INTO [WORD_LIST_TABLE] (word, definition) VALUES ('gamma','third_letter')");
    }
